...
<div align="center">
  <sub>The NLW #2 project. Built with ❤︎ by
    <a href="https://github.com/RodrigoSabino02">Rodrigo Sabino</a>
    </a>
  </sub>
</div>
...
```bash
# Clone o Repositoria
$ git clone https://github.com/RodrigoSabino02/nlw-2.git
```
### 📦 Rode a API
...
Fique a vontade **para criar uma nova issue** com o respectivo titulo e descrição na página de issues do [Proffy](https://github.com/RodrigoSabino02/nlw-2/issues) Repositorio. Se você já encontrou a solução para o problema, **Eu amaria fazer o review do seu pull request**!
...
Made with love by [Rodrigo Sabino](https://github.com/RodrigoSabino02) 🚀.
